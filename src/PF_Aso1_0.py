...
def init_H(Λ_scale, cd_scale):
    ...
    H0 = {'1st':[np.array([[1],[1]]), np.eye(2) * Λ_scale, 1 * cd_scale, 1 * cd_scale], 
          '2nd':[np.array([[0],[0]]), np.eye(2) * Λ_scale, 1 * cd_scale, 1 * cd_scale], 
          '3rd':[np.array([[0], [0], [0]]), np.eye(3) * Λ_scale, 1 * cd_scale, 1 * cd_scale], 
          '4th':[np.array([[0], [0], [0], [0], [0]]), np.eye(5) * Λ_scale, 1 * cd_scale, 1 * cd_scale],
          '5th':[np.array([[0], [0], [0], [0], [0], [0]]), np.eye(6) * Λ_scale, 1 * cd_scale, 1 * cd_scale]}
